...
public class AnnouncementHelper {
    ...
    public static AnnouncementResponse.AnnouncementGetDetailResponse toDto(Announcement announcement) {
        AnnouncementResponse.AnnouncementGetDetailResponse dto = AnnouncementResponse.AnnouncementGetDetailResponse.builder()
